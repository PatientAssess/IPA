...
async def send_prompt(pr: prompt):
    ...
    history = [{
        ...
        'content': (
            ...
            'чтобы понять его жалобы и предположить возможное заболевание. Задавайте короткие,последовательные,'
            'вежливые, вопросы о самочувствии и симптомах. Никогда не ставьте диагноз — скажите, '
